...
class TestStorageCPKN(StorageRecordedTestCase):
    def _setup(self, bsc):
    ...
    def test_put_block_and_put_block_list(self, **kwargs):
        ...
        blob_client.stage_block('2', b'BBB', encryption_scope=TEST_ENCRYPTION_SCOPE)
    ...
    @BlobPreparer()
    @recorded_by_proxy
    def test_put_block_and_put_block_list_with_blob_sas(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
    ...
    @BlobPreparer()
    @recorded_by_proxy
    def test_put_block_and_put_block_list_with_blob_sas_fails(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
    ...
    @BlobPreparer()
    @recorded_by_proxy
    def test_list_blobs_using_container_encryption_scope_sas(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
    ...
    @BlobPreparer()
    @recorded_by_proxy
    def test_copy_with_account_encryption_scope_sas(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
    ...
    @pytest.mark.live_test_only
    @BlobPreparer()
    def test_copy_with_user_delegation_encryption_scope_sas(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
    ...
    @BlobPreparer()
    @recorded_by_proxy
    def test_create_container_with_default_cpk_n(self, **kwargs):
        storage_account_name = kwargs.pop("storage_account_name")
        storage_account_key = kwargs.pop("storage_account_key")
